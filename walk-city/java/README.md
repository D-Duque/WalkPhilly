...
|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `01_createdb.sql`    | This script destroys the database so that it can be recreated. It drops the database and associated users. The project team **SHOULD NOT** modify this script.                                                     |
| `02_schema.sql`      | This script creates all of the database objects, such as tables and sequences. The project team should modify this script.                                                                                             |
| `03_data.sql`        | This script populates the database with any static setup data or test/demo data. The project team should modify this script.                                                                                           |
| `04_constraints.sql` | This script creates the foreign key constraints for the tables created in the `02_schema.sql` script. The project team should modify this script                                                                       |
| `05_user.sql`        | This script creates the database application users and grants them the appropriate privileges. The project team **SHOULD NOT** modify this script. <br /> See the next section for more information on these users. |
